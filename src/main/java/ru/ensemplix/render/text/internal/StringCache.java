...
public class StringCache {
    ...
    /**
     * Color codes from original TextRenderer class. First 16 entries are the primary chat colors; second 16 are darker versions
    ...
    static private class Entry {
        ...
        private WeakReference<Key> keyRef;
    ...
    static private class ColorCode implements Comparable<Integer> {
        ...
        private static final byte STRIKETHROUGH = 2;
    ...
    static private class Glyph implements Comparable<Glyph>
    {
        ...
        private GlyphCache.Entry texture;
